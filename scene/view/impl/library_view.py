...
@component
@registry.register(component_type=ComponentType.SCENE_VIEW, name="LIBRARY_VIEW")
class LibraryView(SceneView):
    ...
    def load(self, page: flet.Page) -> SceneView:
        ...
        content_control.content = flet.Text("Контент library страницы")
