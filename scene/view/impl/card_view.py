...
@component
@registry.register(component_type=ComponentType.SCENE_VIEW, name="CARD_VIEW")
class CardView(SceneView):
    ...
    def load(self, page: flet.Page) -> SceneView:
        ...
        content_control.content = flet.Text("Контент card страницы")
